    ...
    <section className="border-t border-deep-green/10 bg-deep-green py-28">
      <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        >
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-full bg-terracotta px-12 py-5 font-medium tracking-widest text-white shadow-lg transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-terracotta/30 focus:outline-none focus:ring-2 focus:ring-terracotta focus:ring-offset-2 focus:ring-offset-deep-green"
          >
            Demander un devis
          </Link>
        </motion.div>
