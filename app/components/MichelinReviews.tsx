...
export default function MichelinReviews() {
  return (
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {reviews.map((review, index) => (
            <motion.figure
              ...
              whileHover={{ y: -6 }}
              className="flex flex-col justify-between rounded-3xl bg-white p-8 shadow-[0_18px_50px_rgba(15,31,24,0.1)] transition-shadow duration-300 hover:shadow-[0_28px_60px_rgba(15,31,24,0.18)]"
            >
              <div>
