  ...
  return (
    <>
      <section className="hero-section relative overflow-hidden bg-mds-bg">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center px-6 lg:min-h-[96vh] lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:px-8 lg:py-28">
          <HeroContent />
          ...
          <motion.div
            ...
            className="hero-secondary-card hidden w-full max-w-md lg:mx-0 lg:block lg:max-w-none"
          >
      ...
      <section
        className="hero-composer-mobile border-t border-mds-border bg-mds-bg px-6 py-12 lg:hidden"
        aria-label="Composez votre réception"
      >
        <motion.div
