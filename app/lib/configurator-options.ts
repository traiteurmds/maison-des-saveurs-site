...
export const CONFIGURATOR_OPTIONS: ConfiguratorOption[] = [
  {
    ...
    alt: "Kit vaisselle individuelle — assiettes, couverts dorés et verres par personne",
  },
  {
    id: "decoration-table",
    ...
    image: "/images/vaisselle/decoration.jpg",
    alt: "Décoration de table complète pour réception traiteur Lyon",
  },
  {
    id: "serveurs",
    title: "Serveurs",
    ...
    alt: "Équipe de serveurs professionnels pour réception traiteur",
  },
  {
    id: "pain-boissons",
    title: "Pain & Boissons",
    ...
    alt: "Pack pain et boissons pour réception traiteur Lyon",
  },
];
